...
public class YearAnalysis extends AppCompatActivity {

    private dbHelper helper = new dbHelper(YearAnalysis.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //New PieChart
        piechart = findViewById(R.id.year_chart_analysis);
        ipiechart = findViewById(R.id.year_chart_income);
...
////////////////////////////////////////////////////////////////////////////////////
        ...
        calendar1.set(Calendar.MONTH,00);
